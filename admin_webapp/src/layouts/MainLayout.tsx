...
import { useUserStore } from '../store/userStore'; // Assuming this path for the user store
                ...
                <header className="h-20 glass sticky top-0 z-40 px-8 flex items-center justify-between border-b border-white/5">
                    <div className="relative w-96">
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-sm transition-all"
                        />
                    </div>
